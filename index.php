...
<body>
    ...
    <div class="container-fluid">
        <a class="btn btn-success pull-right" href="cadastrar_usuario.php">Novo Registro</a>
            ...
            <tbody>
                <?php foreach ($efetivo as $militar) : ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn" href="atualizar_usuario.php?id=<?php echo $militar->id ?>">Editar</a>
    ...
    <?php include("delete_usuario.php") ?>
